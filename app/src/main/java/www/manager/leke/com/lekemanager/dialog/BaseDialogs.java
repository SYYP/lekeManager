...
public class BaseDialogs extends Dialog {
    ...
    public BaseDialogs(Builder builder) {
        super(builder.bContext);
    }

    public BaseDialogs(Builder builder, int themeResId) {
    ...
    public static final class Builder {
        ...
        public BaseDialogs builder() {
            return new BaseDialogs(this, bThemeResId);
        }
    }
